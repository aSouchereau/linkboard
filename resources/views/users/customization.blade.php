            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @endif
                        <div class="col-6">
                            <form method="POST" action="{{ action([App\Http\Controllers\CustomizationController::class, 'storeBackgroundImage']) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                            ...
                            <form method="POST" action="{{ action([\App\Http\Controllers\CustomizationController::class, 'removeBackgroundImage']) }}">
